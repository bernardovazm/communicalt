...
<h1 class="blacktext"> COMMUNICALT <strong>ADMINISTRADOR </strong></h1> 
  ...
  <div class="form">
      <nav>
      <ul class="tab-group">
        <li class="tab"><a href="index.html">Cadastrar</a></li>
        <li class="tab active "><a href="#logintab">Logar</a></li>
      </ul>
      </nav>
        <div id="logintab">  
		  ...
		  <p>Senha</p>
            ...
            <input name="senha" id="senha" type="password" required autocomplete="off"/>
          </div>
		  ...
		  <p>Por favor, conclua a verificação anti robô a seguir...</p>
			<div class="field-wrap">
				<div id="captcha" name="Não sou um robô" >
				</div>
			<label>
			</label>
				...
				<button type="submit"  id="entrar" name="entrar" class="button button-block">Logar</button>
